   ...
   const extraDetail =[
    ...
    return(
       ...
       <Typography variant="h6">
        Exercise Keep you strong and help you improve your mood and gain energy
        , {name} is one of the best exercises to target your {target}. 
        Make sure to do the exercise with the correct technique or you can hurt yourself
